...
<script type="text/javascript">
    ...
    var countyURL = base_url + 'order_settings/fetch/counties'
    var subcountyURL = base_url + 'order_settings/fetch/district'
    $(function () {
    ...
    function LoadDetails(table, id) {
        var detailsURL = base_url + 'order_settings/get_details/' + table + '/' + id
    ...
    function ChangeUrl(resource_table, resource_id) {
        var newURL = base_url + "order_settings/update/" + resource_table + "/" + resource_id
