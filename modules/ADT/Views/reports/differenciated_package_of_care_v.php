<div id="wrapperd">
	...
	<div id="patient_enrolled_content" class="full-content">
		...
		<h4 style="text-align: center" id='report_title'>Listing of Patients on Differentiated Package of Care during the period <span id="start_date"><?php echo date('d-M-Y', strtotime($from)); ?></span> to <span id="start_date"><?php echo date('d-M-Y', strtotime($to)); ?></span> </h4>
