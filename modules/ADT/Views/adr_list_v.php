<style type="text/css">
    ...
    <div class="row" id="pv_form">
        <div class="span11" style="background: #fdfdfd;">
            <a class="button disabled" href="<?php echo base_url().'/' . '/pqmp/0/0'; ?>">PQMP</a>
            <a class="button info" href="<?php echo base_url().'/' . '/adr/0/0'; ?>">ADR</a>
            <hr>
        </div>
        <div class="span11">
                            ...
                            <tr>
                             ...
                             <td style="width:50px;">
                                <?php if ($adr['synch'] == '0') { ?>
                                    ...
                                    <a href="<?= base_url().'/'; ?>inventory_management/deladr/<?= $adr['id']; ?>/delete"><span style="color:red;font-weight: bold;"> Delete</span></a>
                                <?php } else { ?>
                                    <a href="<?= base_url().'/'; ?>inventory_management/loadAdrRecord/<?= $adr['id']; ?> "> View</a>
                                <?php } ?>
                            </td> 
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('#create_adr_btn').click(function (e) {
            e.preventDefault();
            window.location.href = "<?=base_url().'/'?>adr_view/adr/"+$('#new_patient_adr').val();
