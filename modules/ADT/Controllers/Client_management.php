    ...
    public function listing() {
        ...
        foreach ($sources as $source) {
            ...
            if ($access_level == "facility_administrator") {
                ...
                if ($source->active == 1) {
                    $links .= " | ";
                    $links .= anchor(base_url().'/client_management/disable/' . $source->id, 'Disable', array('class' => 'disable_user'));
                } else {
                    $links .= anchor(base_url().'/client_management/enable/' . $source->id, 'Enable', array('class' => 'enable_user'));
                }
            }
