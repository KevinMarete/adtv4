...
class Drug_stock_balance_sync extends \App\Controllers\BaseController {
    ...
    public function view_balance() {
        ...
        echo view('\Modules\ADT\Views\\running_balance_v', $data);
    }
    ...
    public function getRunningBalance() {
        ...
        foreach ($stores as $store) {
            ...
            if ($difference != 0) {
                ...
                //update running_balance in machine code column
                $id = $this->db->query("SELECT MAX(id) FROM drug_stock_movement")->getResult()[0]->id;
    ...
    function update_balances() {
        ...
        echo $this->db->affectedRows() . " Drug balances have been updated successfully.";
    }
