...
<script src="<?php echo base_url().'/public/assets/scripts/jquery.uploadify.js'?>" type="text/javascript"></script>
<script src="<?php echo base_url().'/public/assets/scripts/nascop.js'?>" type="text/javascript"></script>
<script src="<?php echo base_url().'/public/assets/scripts/ie10-viewport-bug-workaround.js'?>" type="text/javascript"></script>