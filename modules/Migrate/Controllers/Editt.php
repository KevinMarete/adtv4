...
class Editt extends \CodeIgniter\Controller {
    ...
    public function index() {
        ...
        echo view('\Modules\Migrate\Views\\migrator_view', $data);
    }
...
//        if (!$this->session->get('source_database')) {
//            $this->session->set($this->config->item($config_file));
//        }
