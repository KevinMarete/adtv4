...
class Access extends \CodeIgniter\Controller {
    ...
    public function index() {
        ...
        $data['stores'] = $query->getResultArray();
        //get databases in server
        $sql = "SHOW DATABASES";
        $query = $this->db->query($sql);
        $data['databases'] = $query->getResultArray();
        //get tables
        $data['tables'] = $this->mapping();
        //migration view
        $data['content_view'] = "\Modules\Migrate\Views\\access_view";
