...
class Sync_drug extends Doctrine_Record {
	...
	public function getActive() {
		...
		$query = Doctrine_Query::create() -> select("id,packsize,$drug_name") -> from("sync_drug") -> where("Active = '1' and (category_id='1' or category_id='2' or category_id='3' or category_id='4')") -> orderBy("category_id, name");
		$sync_drug = $query -> execute(array(), Doctrine::HYDRATE_ARRAY);
		return $sync_drug;
	}
	...
	public function getActiveList() {
		...
		$query = Doctrine_Query::create() -> select("id,$drug_name") -> from("sync_drug") -> where("Active = '1' and (category_id='1' or category_id='2' or category_id='3' or category_id='4')") -> orderBy("category_id, name");
