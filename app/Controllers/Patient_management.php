...
class Patient_management extends MY_Controller {
    ...
    public function save() {
        ...
        $new_patient->rifap_isoniazid_start_date = $this->input->post('rifa_iso_start_date', TRUE);
        $new_patient->rifap_isoniazid_end_date = $this->input->post('rifa_iso_end_date', TRUE);
