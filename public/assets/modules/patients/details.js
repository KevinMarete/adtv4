...
function checkGuardian(age) {
    ...
    var facility_age_url = base_url + "/public/dispensement/getFacililtyAge";
...
function getViralLoad() {
    ...
    var link = base_url + "/public/auto_management/get_viral_load/" + patient_no;
    var table = '';
...
function getViralResult(ccc_no) {
    var data_source = base_url + "/public/patient/get_Last_vl_result/" + ccc_no;
...
function get_patient_prescriptions(ccc_no) {
    var data_source = base_url + "/public/dispensement/getPrescriptions/" + ccc_no;
    var patient_id = $("#hidden_data").data("patient");
    ...
    $.getJSON(data_source, function (data) {
        ...
        $.each(data.prescription_details, function (key, val) {
            ...
            $('#dispense_prescription_btn').attr('href', base_url + '/public/dispensement/dispense/' + patient_id + '?pid=' + val.drug_prescriptionid);
        });
